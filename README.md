...
## cloudwatch_metrics_collector (melodic) - 2.2.1-2

The packages in the `cloudwatch_metrics_collector` repository were released into the `melodic` distro by running `/usr/local/bin/bloom-release cloudwatch_metrics_collector --track melodic --rosdistro melodic -e` on `Fri, 27 Mar 2020 23:59:56 -0000`
...
## cloudwatch_metrics_collector (melodic) - 2.2.0-1

The packages in the `cloudwatch_metrics_collector` repository were released into the `melodic` distro by running `/usr/local/bin/bloom-release cloudwatch_metrics_collector --track melodic --rosdistro melodic -e` on `Wed, 22 Jan 2020 22:14:50 -0000`
...
## cloudwatch_metrics_collector (kinetic) - 2.2.0-1

The packages in the `cloudwatch_metrics_collector` repository were released into the `kinetic` distro by running `/usr/local/bin/bloom-release cloudwatch_metrics_collector --track kinetic --rosdistro kinetic -e` on `Wed, 22 Jan 2020 22:10:21 -0000`
...
## cloudwatch_metrics_collector (dashing) - 3.0.0-2

The packages in the `cloudwatch_metrics_collector` repository were released into the `dashing` distro by running `/usr/bin/bloom-release -t dashing -r dashing cloudwatch_metrics_collector` on `Sun, 08 Sep 2019 18:58:50 -0000`
...
## cloudwatch_metrics_collector (dashing) - 3.0.0-1

The packages in the `cloudwatch_metrics_collector` repository were released into the `dashing` distro by running `/home/ANT.AMAZON.COM/miaofei/.local/bin/bloom-release cloudwatch_metrics_collector --track dashing --rosdistro dashing -e` on `Fri, 06 Sep 2019 23:52:15 -0000`
...
## cloudwatch_metrics_collector (melodic) - 2.1.1-1

The packages in the `cloudwatch_metrics_collector` repository were released into the `melodic` distro by running `/usr/bin/bloom-release cloudwatch_metrics_collector --track melodic --rosdistro melodic -e` on `Fri, 26 Jul 2019 17:35:55 -0000`
...
## cloudwatch_metrics_collector (kinetic) - 2.1.1-1

The packages in the `cloudwatch_metrics_collector` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release cloudwatch_metrics_collector --track kinetic --rosdistro kinetic -e` on `Fri, 26 Jul 2019 17:33:31 -0000`
...
## cloudwatch_metrics_collector (melodic) - 2.1.0-1
